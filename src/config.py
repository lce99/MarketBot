...
SUMMARY_DB_PATH = DB_PATH
RAW_DB_PATH = DATA_DIR / "marketbot_raw.db"
...
VN_RATE_LIMIT_PER_MINUTE = int(os.getenv("VN_RATE_LIMIT_PER_MINUTE", "18"))
VN_FULL_REBUILD_MAX_TICKERS = int(os.getenv("VN_FULL_REBUILD_MAX_TICKERS", "120"))
VN_CHECKPOINT_BATCH_SIZE = int(os.getenv("VN_CHECKPOINT_BATCH_SIZE", "25"))
VN_FAILURE_POLICY_LOOKBACK_RUNS = int(os.getenv("VN_FAILURE_POLICY_LOOKBACK_RUNS", "6"))
VN_FAILURE_STREAK_THRESHOLD = int(os.getenv("VN_FAILURE_STREAK_THRESHOLD", "2"))
VN_DEGRADED_MAX_TICKERS = int(os.getenv("VN_DEGRADED_MAX_TICKERS", "40"))
